        ...
        <TouchableWithoutFeedback >
            <Container>
                <ContainerHead >
                    ...
                    <Text style={{ color: 'white', fontSize: 14 }}>Vui lòng đăng nhập với thông tin tài khoản của bạn</Text>
                </ContainerHead>
                <ContainerBody>
                    <LoginForm />
                    <ContainerBodyFooter>
                        <Text>
                            Bạn chưa có tài khoản<Text style={{ fontWeight: 'bold', color: '#2196F3' }}>Đăng ký ngày</Text>
                        </Text>
